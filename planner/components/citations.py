...
NC_MEDIAN_SOURCES = [
    ("Individual income",     "$38,657/yr",  "U.S. Census Bureau, American Community Survey", "2024"),
    ("Gross rent",             "$1,200/mo",   "U.S. Census Bureau, American Community Survey", "2023"),
    ("Transportation costs",  "$831/mo",     "NC Dept. of Commerce / BLS Consumer Expenditure data", "2024"),
...
ESTIMATED_ITEMS = [
    ...
    "The $10k/yr side-hustle business numbers (a scenario assumption, not Census or industry data)",
]
        ...
        [
            ...
            dbc.Collapse(
                html.Div(
                    [
                        html.P(
                            "This project ships with example values based on North Carolina's median "
                            "household, not a blank $0 template, so the numbers below are realistic "
                            "starting points. Replace them with your own on the Personal and Business pages.",
