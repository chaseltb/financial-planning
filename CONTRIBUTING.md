...
- `planner/engines/` — the actual math: cash flow, net worth, forecast, valuation, scenario diffing, and tax calculation (`engines/tax/`, backed by `planner/tax_rules/<year>/`)
